...
-- AlterTable
ALTER TABLE "users" ADD COLUMN     "use_ETANOL_COMUM_comb" DOUBLE PRECISION,
ADD COLUMN     "use_GASOLINA_COMUM_comb" DOUBLE PRECISION,
ADD COLUMN     "use_OLEO_DIESEL_B_S10_COMUM_comb" DOUBLE PRECISION,
ADD COLUMN     "use_OLEO_DIESEL_B_S500_COMUM_comb" DOUBLE PRECISION;
