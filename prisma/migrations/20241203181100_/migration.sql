-- AlterTable
ALTER TABLE "gas_station_setvariables" ADD COLUMN     "gas_station_margin_FILTROS_AR_PRODUCT" DOUBLE PRECISION,
ADD COLUMN     "gas_station_sanado_hour_margin_FILTROS_AR_PRODUCT" TIMESTAMP(3),
ADD COLUMN     "gas_station_sanado_margin_FILTROS_AR_PRODUCT" BOOLEAN,
ADD COLUMN     "gas_station_type_margin_FILTROS_AR_PRODUCT" BOOLEAN,
ADD COLUMN     "verification_hour_margin_FILTROS_AR_PRODUCT" TIMESTAMP(3) DEFAULT '2023-01-01T00:00:00Z',
...
-- AlterTable
ALTER TABLE "ibm_info" ADD COLUMN     "ibm_margin_FILTROS_AR_PRODUCT" DOUBLE PRECISION[];
